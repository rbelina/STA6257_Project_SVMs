...
The fundamental concept behind SVMs is to find an optimal hyperplane that maximally separates different classes or fits the data points for regression, while simultaneously maintaining a clear margin between them (Kecman, 2005).
...
By emphasizing the importance of the margin, SVMs can effectively handle datasets with high dimensionality, noise, and outliers, resulting in superior performance in complex scenarios.
...
Through techniques such as one-vs-one and one-vs-all, SVMs can extend their capabilities to accommodate multiple classes, ensuring accurate predictions across diverse scenarios.
...
By employing support vector regression (SVR), SVMs can capture nonlinear relationships in continuous variables, making them well-suited for prediction tasks involving numerical outputs.
...
By understanding the underlying principles and techniques of SVMs, researchers and practitioners can effectively leverage this powerful tool to tackle complex classification and regression problems, ultimately leading to enhanced predictive accuracy and insightful data analysis.
[@efr2008].
...
Evgeny Byvatov, & Schneider, G. (2003). Support vector machine applications in bioinformatics. Applied Bioinformatics, 2(2), 67–77.

Kecman, V. (2005). Support Vector Machines – An Introduction. Support Vector Machines: Theory and Applications, 177, 1–47. https://doi.org/10.1007/10984697_1
...
Yang, Z. R. (2004). Biological applications of support vector machines. Briefings in Bioinformatics, 5(4), 328–338. https://doi.org/10.1093/bib/5.4.328
