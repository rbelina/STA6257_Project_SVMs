...
By emphasizing the importance of the margin, SVMs can effectively handle datasets with high dimensionality, noise, and outliers, resulting in superior performance in complex scenarios \[@Tian et al., 2012\].
...
By understanding the underlying principles and techniques of SVMs, researchers and practitioners can effectively leverage thi\$\$s powerful tool to tackle complex classification and regression problems, ultimately leading to enhanced predictive accuracy and insightful data analysis \[@Yang, 2004\] Cite this paper [@bro2014principal].
...
The Analyst, 135(2), 230--267.
https://doi.org/10.1039/b918972f

Evgeny Byvatov, & Schneider, G.
(2003).
Support vector machine applications in bioinformatics.
Applied Bioinformatics, 2(2), 67--77.

Kecman, V. (2005).
Support Vector Machines -- An Introduction.
Support Vector Machines: Theory and Applications, 177, 1--47.
https://doi.org/10.1007/10984697_1

Tian, Y., Shi, Y., & Liu, X.
(2012).
RECENT ADVANCES ON SUPPORT VECTOR MACHINES RESEARCH. Technological and Economic Development of Economy, 18(1), 5--33.
https://doi.org/10.3846/20294913.2012.661205

Yang, Z. R.
(2004).
Biological applications of support vector machines.
Briefings in Bioinformatics, 5(4), 328--338.
