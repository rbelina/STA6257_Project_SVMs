...
From the above model, we found that the non-linear SVM was very similar to the the Bayes decision boundary, showcasing support vector machine's ability as a classification tool.
